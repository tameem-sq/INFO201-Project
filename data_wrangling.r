...
columns_to_keep <- c("State_Name", "County", "City", "Zip_Code", "AllSbjtNumReady", "AllSbjtNumAssessed", "Lat", "Lon", "Median_Income" = "Median", "FinalMathAveScore", "FinalAllSbjtAveScore", "FinalEWBRWAveScore", "MathPctReady", "TotalPerReady" = "AllSbjtPctReady", "EBRWPctReady")
